...
def add_event(event_id: str, title: str, description: str, start_time: str, end_time: str, creator: str, channel: str) -> None:
...
def get_channel_events(channel: str) -> List[Dict[str, Any]]:
    with get_connection() as conn:
        cursor = conn.execute(
